...
// CPhotoEditor2Dlg dialog



CPhotoEditor2Dlg::CPhotoEditor2Dlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CPhotoEditor2Dlg::IDD, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CPhotoEditor2Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
...
BEGIN_MESSAGE_MAP(CPhotoEditor2Dlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_OPEN, &CPhotoEditor2Dlg::OnBnClickedOpen)
	ON_BN_CLICKED(IDC_UNDO, &CPhotoEditor2Dlg::OnBnClickedUndo)
	ON_BN_CLICKED(IDC_SAVE, &CPhotoEditor2Dlg::OnBnClickedSave)
	ON_BN_CLICKED(IDC_SAVEAS, &CPhotoEditor2Dlg::OnBnClickedSaveas)
	ON_BN_CLICKED(IDC_REDO, &CPhotoEditor2Dlg::OnBnClickedRedo)
	ON_BN_CLICKED(IDC_CROP_OK, &CPhotoEditor2Dlg::OnBnClickedCropOk)
	ON_BN_CLICKED(IDC_RESIZE_OK, &CPhotoEditor2Dlg::OnBnClickedResizeOk)
	ON_BN_CLICKED(IDC_GRAY, &CPhotoEditor2Dlg::OnBnClickedGray)
	ON_BN_CLICKED(IDC_INVERT, &CPhotoEditor2Dlg::OnBnClickedInvert)
	ON_BN_CLICKED(IDC_ROTATE, &CPhotoEditor2Dlg::OnBnClickedRotate)
	ON_BN_CLICKED(IDC_FLIP1, &CPhotoEditor2Dlg::OnBnClickedFlip1)
	ON_BN_CLICKED(IDC_FLIP2, &CPhotoEditor2Dlg::OnBnClickedFlip2)
	ON_NOTIFY(NM_RELEASEDCAPTURE, IDC_SAT_SLIDER, &CPhotoEditor2Dlg::OnReleasedcaptureSatSlider)
	ON_NOTIFY(NM_RELEASEDCAPTURE, IDC_BRIGHT_SLIDER, &CPhotoEditor2Dlg::OnReleasedcaptureBrightSlider)
	ON_NOTIFY(NM_RELEASEDCAPTURE, IDC_BLUR_SLIDER, &CPhotoEditor2Dlg::OnReleasedcaptureBlurSlider)
	ON_WM_CLOSE()
	ON_BN_CLICKED(IDC_COLOR_OK, &CPhotoEditor2Dlg::OnBnClickedColorOk)
	ON_BN_CLICKED(IDC_HISTOGRAM, &CPhotoEditor2Dlg::OnBnClickedHistogram)
	ON_BN_CLICKED(IDC_BINARY, &CPhotoEditor2Dlg::OnBnClickedBinary)
	ON_NOTIFY(NM_RELEASEDCAPTURE, IDC_HUE, &CPhotoEditor2Dlg::OnReleasedcaptureHue)
	ON_BN_CLICKED(IDC_EDGE, &CPhotoEditor2Dlg::OnBnClickedEdge)
	ON_NOTIFY(NM_RELEASEDCAPTURE, IDC_CONTRAST, &CPhotoEditor2Dlg::OnReleasedcaptureContrast)
	ON_BN_CLICKED(IDC_ABOUTBUTTON, &CPhotoEditor2Dlg::OnBnClickedAboutbutton)
END_MESSAGE_MAP()


void CPhotoEditor2Dlg::update_image(CString file_name)
{
...
string CPhotoEditor2Dlg::fname(CString file_name)
{
...
void CPhotoEditor2Dlg::update_res(int version)
{
...
double CPhotoEditor2Dlg::val(const CEdit &input_box)
{
	CString str = _T("");
...
// CPhotoEditor2Dlg message handlers

BOOL CPhotoEditor2Dlg::OnInitDialog()
{
...
void CPhotoEditor2Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CPhotoEditor2Dlg::OnQueryDragIcon()
{
	return static_cast<HCURSOR>(m_hIcon);
}


void CPhotoEditor2Dlg::OnBnClickedOpen()			// còn vấn đề mở 2 file trong một lần chạy ct
{
...
void CPhotoEditor2Dlg::OnBnClickedUndo()
{
	if (BMP_vers.empty())
		return;
...
void CPhotoEditor2Dlg::OnBnClickedRedo()
{
	if (BMP_vers.empty())
		return;
...
void CPhotoEditor2Dlg::OnBnClickedSave()		//save vào file, chứ BMP_vers[0] thì vẫn ko đổi
{
	if (BMP_vers.empty())
		return;
...
void CPhotoEditor2Dlg::OnBnClickedSaveas()
{
	if (BMP_vers.empty())
		return;
...
void CPhotoEditor2Dlg::OnBnClickedCropOk()
{
	if (BMP_vers.empty())
		return;
...
void CPhotoEditor2Dlg::OnBnClickedResizeOk()
{
	if (BMP_vers.empty())
		return;
...
void CPhotoEditor2Dlg::OnBnClickedGray()
{
	if (BMP_vers.empty())
		return;
...
void CPhotoEditor2Dlg::OnBnClickedInvert()
{
	if (BMP_vers.empty())
		return;
...
void CPhotoEditor2Dlg::OnBnClickedRotate()
{
	if (BMP_vers.empty())
		return;
...
void CPhotoEditor2Dlg::OnBnClickedFlip1()
{
	if (BMP_vers.empty())
		return;
...
void CPhotoEditor2Dlg::OnBnClickedFlip2()
{
	if (BMP_vers.empty())
		return;
...
void CPhotoEditor2Dlg::OnReleasedcaptureSatSlider(NMHDR *pNMHDR, LRESULT *pResult)
{
	if (BMP_vers.empty())
	{
		sat_slider.SetPos(25);
...
void CPhotoEditor2Dlg::OnReleasedcaptureBrightSlider(NMHDR *pNMHDR, LRESULT *pResult)
{
	if (BMP_vers.empty())
	{
		bright_slider.SetPos(25);
...
void CPhotoEditor2Dlg::OnReleasedcaptureBlurSlider(NMHDR *pNMHDR, LRESULT *pResult)
{
	if (BMP_vers.empty())
	{
		blur_slider.SetPos(0);
...
void CPhotoEditor2Dlg::OnReleasedcaptureHue(NMHDR *pNMHDR, LRESULT *pResult)
{
	if (BMP_vers.empty())
	{
		hue_slider.SetPos(180);
...
void CPhotoEditor2Dlg::OnReleasedcaptureContrast(NMHDR *pNMHDR, LRESULT *pResult)
{
	if (BMP_vers.empty())
	{
		contrast_slider.SetPos(25);
...
void CPhotoEditor2Dlg::OnBnClickedColorOk()
{
	if (BMP_vers.empty())
		return;
...
void CPhotoEditor2Dlg::OnBnClickedHistogram()
{
	if (BMP_vers.empty())
		return;
...
void CPhotoEditor2Dlg::OnBnClickedBinary()
{
	if (BMP_vers.empty())
		return;
...
void CPhotoEditor2Dlg::OnBnClickedEdge()
{
	if (BMP_vers.empty())
		return;
...
void CPhotoEditor2Dlg::OnBnClickedAboutbutton()
{
